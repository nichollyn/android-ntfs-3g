...
// kevin@xmic: android already defined, rename it to avoid confliction.
//#define HAVE_ENDIAN_H 1
#define GOT_ENDIAN_H 1
...
// kevin@xmic: android doesn't support it.
...
#define HAVE_STRUCT_STAT_ATIMENSEC 1
...
// kevin@xmic: android doesn't support statvfs, so we will roll back to statfs.
...
#define PACKAGE_STRING "ntfs-3g 2012.1.05 modified by kevin for android 4.0.4"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "ntfs-3g"

/* Define to the version of this package. */
#define PACKAGE_VERSION "2012.1.02 modified by kevin for android 4.0.4"
...
#define VERSION "2012.1.05 modified by kevin for android 4.0.4"
...
//<< kevin@xmic
// kevin@xmic: should define off_t to long long as a 64bits type
/*XXX Define to `long int' if <sys/types.h> does not define. */
/* #undef off_t */
